...
\section*{\underline{\textcolor{red}{\textbf{I. Repère }}}}
\section*{\underline{\textcolor{red}{\textbf{$\ast$ Repère de la droite}}}}
\subsection*{\underline{\textcolor{red}{\textbf{1.Définition}}}}
...
$x_{D}=?$
\subsection*{\underline{\textcolor{red}{\textbf{b.Mesure algébrique}}}}
...
\end{itemize}
\subsection*{\underline{\textcolor{red}{\textbf{$\ast$ Repère du plan}}}}
...
Soit le repère du plan $(O;\vec{i};\vec{j})$ pour tout point M du plan, il existe un unique couple de nature $(x;y)$ tel que $\overrightarrow{OM}=x\vec{i}+x\vec{j}$
\begin{itemize}
...
\subsection*{\underline{\textcolor{red}{\textbf{Solution}}}}
\subsection*{\underline{\textcolor{red}{\textbf{b.Milieu d'un segment}}}}
Soit $A(x_{A},y_{A})$ et $B(x_{B},y_{B})$ deux point du plan.\\
